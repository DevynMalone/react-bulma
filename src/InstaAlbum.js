...
const titleList = [
    {
        ...
        message: 'This is a very cool photo i took'
    }, {
        title: 'Random photo 2',
        message: 'This is a nice photo i took'
    },{
        title: 'Random photo 3',
        message: 'This is a ugly photo i took'
    },{
        title: 'Random photo 4',
        message: 'This is a fresh pic'}
]

const displayTitleList = titleList.map((tool,index)=>{
    return (
                            ...
                            <div className="header">
                                <div className="media">
                                    ...
                                    <div className="media-content">
                                        <p className="title is-4">{tool.title}</p>
                        ...
                        <div className="card">
                            ...
                            <div className="card-content">
                                ...
                                <div className="content">
                                    ...
                                    <a href="#">#responsive</a>
                                    <br />
                                    <time dateTime="2018-1-1" title='time'>12:02 PM - 1 May 2018</time>
                                </div>
                            </div>
                            <div className="card-footer">
                                <div className="columns is-mobile">
                                    <div className="column is-11">
                                        <div className="field">
                                            <div className="control">
                                                <input className="input is-medium" type="text" placeholder="Add a comment . . ." title='comment'/>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="column has-text-centered">
                            ...
                            <div className="container is-fluid">
                                <div className="content has-text-centered">
                                    <p>
                                        ...
                                        <a href="http://jgthms.com" title='license'>Jeremy Thomas</a>. The source code is licensed
